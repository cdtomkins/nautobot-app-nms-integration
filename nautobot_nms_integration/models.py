...
class NautobotNMSIntegrationExampleModel(PrimaryModel):  # pylint: disable=too-many-ancestors
    """Base model for NMS Integration app."""
    ...
    class Meta:
        ...
        # verbose_name_plural = "NMS Integrations"
